...
Phase 13 quality intelligence is in progress at item 13.3: versioned
quality report with plan-bound source, objective, row, role/label,
length, language-where-qualified, exclusion, split, and coverage
distributions. The report does not enforce heuristics. Do not start
...
- `quality/` for the versioned quality report (facts, policy, recommendations; 13.3 distributions; not enforcing);
