...
split-comparability and rare-shape findings. Do not start Phase 14 from
this packet.
...
- `quality/` for the versioned quality report (facts, policy, recommendations; 13.3–13.8 including split findings; not enforcing);
