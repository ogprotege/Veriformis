...
@pytest.mark.parametrize(
    ...
    [
        ...
        ({"goal": "continue-a-passage", "consumer_profile": "trl"}, "not implemented"),
...
@pytest.mark.parametrize(
    ...
    [
        ...
        ("planned profile", lambda p: p["defaults"]["construction"].__setitem__("consumer_profile", "trl"), "not implemented"),
