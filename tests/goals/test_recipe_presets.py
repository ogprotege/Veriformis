...
DATA_SHA256 = "cf85c7207f0d1089aa3b64de59263ea9548bc1142042839375f0e278ebcae43c"
...
@pytest.mark.parametrize(
    ...
    [
        ...
        ({"goal": "continue-a-passage", "consumer_profile": "axolotl"}, "not implemented"),
...
@pytest.mark.parametrize(
    ...
    [
        ...
        ("candidate profile", lambda p: p["defaults"]["construction"].__setitem__("consumer_profile", "axolotl"), "not implemented"),
