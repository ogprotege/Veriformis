...
**Implementation baseline reviewed:** `c0c10b9` on `main` after PR #163
(Groups 1–7; Group 9 automated gates; beta-prep; private beta workbench
Phases 0–2; independent-product Phases 0–17 complete; Phase 18.1–18.4
merged; item 18.5 inspectable settings)

**Product version:** `0.1.0` development alpha (not beta-labeled)

**Last reviewed:** 2026-08-29 (Phase 18.5 inspectable settings)

**Next review:** Phase 18.5 merge, or item 18.6 pre-publication samples.
Do not add Review or Exports execute in this item.

**Operator compile:** `/Users/biscuit/Documents/Veriformis` at
`2026-08-24T13-54-52Z`. Pius X *Pascendi* Markdown → `full_text`/`text`
bundle, 31 train / 0 eval, manifest
`94b63232166aeedc9db797fdc0ec0167b2135d8c01bd3934635250a0a2245ace`.
Seal `self_consistent`; zip `external_digest`. Empty eval is one leakage
group. No trainer or columnar export in that run.
...
- [ ] Independent product Phase 18 is in progress under its
      ...
      Item 18.4 merged as PR #163. Item 18.5 exposes inspectable preset
      and goal contract fields. Do not start Phase 19 from this packet.
