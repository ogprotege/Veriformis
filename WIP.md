...
**Implementation baseline reviewed:** `199e16e` on `main` after PR #88
(Groups 1–7; Group 9 automated gates; beta-prep; private beta workbench
Phases 0–2; independent-product Phases 0–8 complete; Phase 9.1 packet)

**Product version:** `0.1.0` development alpha (not beta-labeled)

**Last reviewed:** 2026-08-23 (independent-product Phase 9.1 packet)

**Next review:** Phase 9.1 pull-request merge, item 9.2, beta label cut, or
...
- [ ] Independent product Phase 9 is in progress under its
      ...
      Item 9.1 opens the packet and refuses planned columnar containers.
