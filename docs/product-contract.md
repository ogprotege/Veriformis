...
`veriformis.advanced-family-admission/v1` pinned as a schema-only contract,
still with no family execute or generator; `veriformis.extension-protocol/v1`
...
**Next review:** Phase 17.2 merge, or any product-contract change. No
modest fig-leaf tier. No public plugin API. Do not execute a family from
item 17.2. Do not start Phase 18 from the Phase 17 packet.
