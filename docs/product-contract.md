...
TRL and MLX-LM optional adapters; Phase 9 columnar schema and fingerprint
pins packaged with Parquet, Arrow, and Hugging Face Dataset still planned; version `0.1.0` development alpha
