...
Phase 12 in progress at item 12.3: Tesseract 5 identities pinned,
`ocr-image` still explicitly unsupported; version `0.1.0` development alpha
...
Phases 0–11 complete; Phase 12 in progress at item 12.3; maturity alpha;
