...
Item 18.2 merged as PR #161. Item 18.3 replaces Aptus-centered copy with
goal-first IA. Default `review_policy` stays `none`. No heuristic blocks
seal.

**Review date:** 2026-08-28 (independent-product Phase 18.3 goal-first IA)

**Next review:** Phase 18.3 merge, item 18.4 input modes, or any
...
| In-progress independent Phase 18.3 | Item 18.2 merged as PR #161; ADR-0019; goal-first IA; copyable CLI equivalent; no Review/Exports/dataset-row execute |
...
Item 18.1 records the current private-beta workbench. Sidebar remains
Home / Compile / History / Settings. Compile remains document-source.
There is no `GeneratorPass`. Do not start Phase 19 from this packet.

The next behavior change is item 18.2 thin-adapter contract. Review,
Exports, and dataset-row execute remain outside this item.
