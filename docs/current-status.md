...
license, parser-threat, secret, and provenance review. There is no version
...
**Next review:** Phase 20.5 clean-machine CLI evidence, or any capability claim change.
