...
| [0009](0009-catalog-default-instructions-and-truthfulness.md) | Catalog-default instructions and deterministic operator truthfulness | Accepted | Goal, representation, instruction policy, prompt template, or persisted instruction meaning change |
