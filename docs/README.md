...
detectors, or any contract change. Do not start Phase 14 from this packet. Default
...
| [Quality Report v1](contracts/quality-report-v1.md) | Facts, policy, recommendations; distributions through tokenizer simulations | Schema pin; not enforcing; unbound tokenizer invents no lengths; no CLI command |
