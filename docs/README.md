...
| [Verified Export Contract v1](contracts/verified-export-v1.md) | Consumer-neutral derivative plans, receipts, and verification evidence | Private two-render exact/semantic conformance implemented; no shipped renderer/replayer, public surface, or supported container |
