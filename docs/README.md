...
Phases 0–18 complete; Phase 19.2 project-spec pin in progress).

**Last reviewed:** 2026-08-31 (independent-product Phase 19.2 project-spec pin)

**Next review:** Phase 19.2 merge, or any contract change. Default parse
...
| [Project Spec v1](contracts/project-spec-v1.md) | Additive compile intent over pipeline/v1 | Schema pin only; loading is not execute |
...
| [Phase 15 packet](../dev/active/independent-product/phase-15-scale/README.md) | Scale, streaming, and sharding | Completed packet; empty published tiers |
