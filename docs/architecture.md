...
under `profiles/` with empty extras. Item 8.3 emits the TRL SFT adapter; item 8.4 emits the MLX-LM LoRA adapter.
Generic export selectors stay `consumer_id` null. Taxonomy remains planned.
