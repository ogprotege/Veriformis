# Phase 15 Decision Index

**Status:** Active

| Decision | State | Basis |
| --- | --- | --- |
| Phase 15 executes as sequential green pull requests; packet opening is 15.1; closeout folds into 15.9 | Accepted | Phases 12–14 precedent; operator instruction 2026-08-25 |
| Repository is public; each item is its own pull request | Accepted | Operator instruction 2026-08-25 |
| Measure before targets; 15.4 is the first item allowed to publish numbers | Accepted | Operator lock 1; roadmap ordering rule 8 |
...
| Disk preflight and bounded queues must not guess; unmeasured amplification cannot claim a preflight | Accepted | Operator lock 9 |
