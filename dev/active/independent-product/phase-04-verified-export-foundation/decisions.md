...
| Python publicly exports the runtime publication outcome and visible-partial exception, while all publication hooks remain private | Accepted | Callers must type success and catch honest visible publication without importing an underscore module |
