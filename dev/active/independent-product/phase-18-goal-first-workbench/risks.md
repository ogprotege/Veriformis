...
| P18-R3 | Controlled for 18.8 | High | High | Empty Review or Exports tabs imply later execute | Exports and Review wrap existing packets |
...
| P18-R7 | Controlled for 18.8 | Medium | High | Review screens require review on every recipe | L8; default `none`; no invented policy |
