...
| P12-R4 | Controlled for 12.3 | High | High | OCR silently replaces a recoverable digital text layer | ADR-0016; recovery not executable; 12.4 owns the split |
| P12-R5 | Open | Medium | High | Cloud OCR or network model fetch during parse | Explicit non-goal; 12.8 harness if ADR accepted |
| P12-R6 | Controlled for 12.2 | Medium | High | Engine choice without retained corpus evidence | 12.2 corpus and Tesseract measurement; operator ADR still required |
