...
| P14-R3 | Open | High | High | A correction mutates accepted records in place | 14.4 owns transforms/mapping revisions; fail closed |
| P14-R4 | Open | High | High | Waiver silently changes bytes | Distinct waiver object in 14.2/14.4 |
