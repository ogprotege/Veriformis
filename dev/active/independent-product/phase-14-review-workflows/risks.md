...
| P14-R5 | Controlled for 14.7 | High | High | Phase 13 heuristics become default required-review | Lock 5; 14.7 stays opt-in |
| P14-R6 | Controlled | Medium | High | Mac Review invents policy in Swift | Lock 1; no Mac work in this packet |
| P14-R7 | Controlled | Low | High | Phase 15 scale work starts from this packet | Packet and ledger forbid it |
