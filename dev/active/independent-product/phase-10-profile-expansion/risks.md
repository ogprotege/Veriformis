...
| P10-R3 | Controlled for 10.2 | High | High | Shipping a profile whose official contract is unstable | Unsloth pin is experimental/not executable; admitted pins are bounded SFT only |
