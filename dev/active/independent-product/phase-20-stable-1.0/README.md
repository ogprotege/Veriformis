...
Phase 20 is in progress. Item 20.1 records honesty locks only. Version remains
`0.1.0` development alpha. ADR-0020 Decision A stands. Hub execute is skipped.
Public signed/notarized Mac is not in the 1.0 matrix unless 20.6 produces
owner-signed evidence (default: skip with a record).
